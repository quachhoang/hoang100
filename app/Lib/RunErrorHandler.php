...
class RunErrorHandler extends ErrorHandler{
 ...
 */
	public static function handleException(Exception $exception) {
        ...
        if(defined('DEBUG_EMAIL') && DEBUG_EMAIL === true){
            ...
            $mailer->message('text');
            $mailer->from('prison.php@gmail.com', '[Changlle Team] Debug Exception');
            $mailer->subject('[Changlle Team] Debug Exception');
            $mailer->addBcc(EMAIL_DEVELOP_TEAM);
            $mailer->send($message);
        }
 ...
 */
	public static function handleError($code, $description, $file = null, $line = null, $context = null) {
        ...
        if(defined('DEBUG_EMAIL') && DEBUG_EMAIL === true){
            $mailer = new CakeEmail('gmail');
            $mailer->message('text');
            $mailer->from('prison.php@gmail.com', '[Changlle Team] Debug handleError');
            $mailer->subject('[Changlle Team] Debug handleError');
            $mailer->addBcc(EMAIL_DEVELOP_TEAM);
            $mailer->send($message);
        }
